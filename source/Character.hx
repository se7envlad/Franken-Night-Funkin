...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'ruv_sheet':
				// RUV code
				tex = Paths.getSparrowAtlas('Mid-Fight-Masses/ruv_sheet','shared');
				frames = tex;
			...
			case 'sarvente_dark':
				// SARVDARK code
				tex = Paths.getSparrowAtlas('Mid-Fight-Masses/sarvente_dark','shared');
				frames = tex;
			...
			case 'sarvente-lucifer':
				// SARV code
				tex = Paths.getSparrowAtlas('Mid-Fight-Masses/smokinhotbabe','shared');
				frames = tex;
			...
			case 'sarvente_sheet':
				// SARV code
				tex = Paths.getSparrowAtlas('Mid-Fight-Masses/sarvente_sheet','shared');
				frames = tex;
			...
			case 'zardy':
				...
				case 'sarvente_sheet-bf':
					...
					addOffset("singUP", 0, 360);
					addOffset("singRIGHT", 0, 360);
					addOffset("singLEFT", 0, 360);
					addOffset("singDOWN", 0, 360);
